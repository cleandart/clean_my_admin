...
var cAuthorChangeOverview = AuthorChangeOverview.register();
class AuthorChangeOverview extends tiles.Component {
  static register() {
    var _registeredComponent = tiles.registerComponent(({props, children}) => new AuthorChangeOverview(props));
  ...
  AuthorChangeOverview(props) : super(props);
  ...
  render() {
    print("RENDERRR");
      return splittedView(table({},
          ...
          tr({"class": '${activeDoc.value == d.index ? "green" : ""}'},[
            td({},'${d.value['after']['_id']}'),
